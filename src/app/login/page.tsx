    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm animate-slide-up">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-zinc-800 bg-zinc-900/50 px-4 py-2.5 text-sm font-medium text-zinc-100 transition-colors hover:bg-zinc-800 hover:border-zinc-700"
        >
